#tag Class
Protected Class FileMenuItemShowInFinder
Inherits MenuItem
	#tag Constant, Name = LocalizedText, Type = String, Dynamic = True, Default = \"Show in Finder", Scope = Public
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Show in Finder"
