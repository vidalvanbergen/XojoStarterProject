#tag Class
Protected Class MenuItemPreferences
Inherits DesktopPreferencesMenuItem
	#tag Event
	...
	#tag Constant, Name = LocalizedText, Type = String, Dynamic = True, Default = \"Preferences", Scope = Public
