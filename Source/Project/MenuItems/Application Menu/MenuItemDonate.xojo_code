#tag Class
Protected Class MenuItemDonate
Inherits DesktopApplicationMenuItem
	#tag Event
	...
	#tag Constant, Name = LocalizedText, Type = String, Dynamic = True, Default = \"Donate...", Scope = Public
		#Tag Instance, Platform = Any, Language = en, Definition  = \"Donate\xE2\x80\xA6"
