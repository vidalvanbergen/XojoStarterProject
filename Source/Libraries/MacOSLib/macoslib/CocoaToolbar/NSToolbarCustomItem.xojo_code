...
Implements NSToolbarItemInterface
	...
	#tag Method, Flags = &h1000
		Sub Constructor(controlInstance as DesktopUIControl)
		  ...
		  // constructor
		    ...
		    if itemRef <> nil then
		      ...
		      elseif controlInstance IsA DesktopUIControl then
	...
	#tag Method, Flags = &h0
		Function Enabled() As Boolean
		  ...
		  elseif mControl <> nil then
		    return DesktopUIControl( mControl ).Enabled
		  end if
	...
	#tag Property, Flags = &h21
		Private mControl As DesktopUIControl
	#tag EndProperty
