#tag Module
Protected Module DesktopLabelExtensions
	#tag Method, Flags = &h0
		Function Editable(Extends LBL as DesktopLabel) As Boolean
	...
	#tag Method, Flags = &h0
		Sub Editable(Extends LBL as DesktopLabel, Assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub LineBreak(extends TF as DesktopLabel, assigns mode as integer)
		  ...
		  //@ It will work only if you set the Multiline option for the Label
		    ...
		    dim ctrl as NSTextField = new NSTextField( TF.Handle, false )
		    dim p as Ptr
	...
	#tag Method, Flags = &h0
		Sub SetAttributedString(extends LBL as DesktopLabel, theString as AttributedString)
