#tag Module
Protected Module DesktopSliderExtension
	#tag Method, Flags = &h0
		Function AllowsTickMarkValuesOnly(Extends s as DesktopSlider) As Boolean
		  //# Returns a Boolean value indicating whether the slider fixes its values to those values represented by its tick marks.
		  
		  #if TargetCocoa then
		    declare function allowsTickMarkValuesOnly lib CocoaLib selector "allowsTickMarkValuesOnly" (obj_id as Ptr) as Boolean
	...
	#tag Method, Flags = &h0
		Sub AllowsTickMarkValuesOnly(Extends s as DesktopSlider, assigns value as Boolean)
		  //# Sets whether the slider’s values are fixed to the values represented by the tick marks.
		  
		  #if TargetCocoa then
		    declare sub setAllowsTickMarkValuesOnly lib CocoaLib selector "setAllowsTickMarkValuesOnly:" (obj_id as Ptr, value as Boolean)
	...
	#tag Method, Flags = &h0
		Function AltIncrementValue(Extends s as DesktopSlider) As Double
		  //# Returns the amount by which the slider changes its value when the user Option–drags the slider knob.
		  
		  #if TargetCocoa then
		    declare function altIncrementValue lib CocoaLib selector "altIncrementValue" (obj_id as Ptr) as Double
	...
	#tag Method, Flags = &h0
		Sub AltIncrementValue(Extends s as DesktopSlider, assigns increment as Double)
		  //# Sets the amount by which the slider modifies its value when the user Option-drags the knob.
		  
		  #if TargetCocoa then
		    declare sub setAltIncrementValue lib CocoaLib selector "setAltIncrementValue:" (obj_id as Ptr, increment as Double)
	...
	#tag Method, Flags = &h0
		Function ClosestTickMarkValueToValue(Extends s as DesktopSlider, value as Double) As Double
		  //# Returns the value of the tick mark closest to the specified value.
		  
		  #if TargetCocoa then
		    declare function closestTickMarkValueToValue lib CocoaLib selector "closestTickMarkValueToValue:" (obj_id as Ptr, value as Double) as Double
	...
	#tag Method, Flags = &h0
		Function ControlSize(Extends s as DesktopSlider) As NSControlSize
	...
	#tag Method, Flags = &h0
		Sub ControlSize(Extends s as DesktopSlider, Assigns value as NSControlSize)
	...
	#tag Method, Flags = &h0
		Function DoubleValue(Extends s as DesktopSlider) As Double
	...
	#tag Method, Flags = &h0
		Sub DoubleValue(Extends s as DesktopSlider, Assigns value as Double)
	...
	#tag Method, Flags = &h0
		Function IntegerValue(Extends s as DesktopSlider) As Integer
	...
	#tag Method, Flags = &h0
		Sub IntegerValue(Extends s as DesktopSlider, Assigns value as Integer)
	...
	#tag Method, Flags = &h0
		Function KnobThickness(Extends s as DesktopSlider) As Double
		  //# Returns the knob’s thickness, in pixels.
		  
		  #if TargetCocoa then
		    declare function knobThickness lib CocoaLib selector "knobThickness" (obj_id as Ptr) as Double
	...
	#tag Method, Flags = &h0
		Sub KnobThickness(Extends s as DesktopSlider, assigns thickness as Double)
		  //# This method has been deprecated. Lets you set the knob’s thickness, measured in pixels.
		  
		  #if TargetCocoa then
		    declare sub setKnobThickness lib CocoaLib selector "setKnobThickness:" (obj_id as Ptr, thickness as Double)
	...
	#tag Method, Flags = &h0
		Function MaxValue(Extends s as DesktopSlider) As Double
	...
	#tag Method, Flags = &h0
		Sub MaxValue(Extends s as DesktopSlider, Assigns value as Double)
	...
	#tag Method, Flags = &h0
		Function MinValue(Extends s as DesktopSlider) As Double
	...
	#tag Method, Flags = &h0
		Sub MinValue(Extends s as DesktopSlider, Assigns value as Double)
	...
	#tag Method, Flags = &h0
		Function NumberOfTickMarks(Extends s as DesktopSlider) As Integer
		  //# Returns the number of tick marks associated with the slider.
		  
		  #if TargetCocoa then
		    declare function numberOfTickMarks lib CocoaLib selector "numberOfTickMarks" (obj_id as Ptr) as Integer
	...
	#tag Method, Flags = &h0
		Sub NumberOfTickMarks(Extends s as DesktopSlider, assigns value as Integer)
		  ...
		  #if TargetCocoa then
		    declare sub setNumberOfTickMarks lib CocoaLib selector "setNumberOfTickMarks:" (obj_id as Ptr, value as Integer)
	...
	#tag Method, Flags = &h0
		Function SingleValue(Extends s as DesktopSlider) As Double
	...
	#tag Method, Flags = &h0
		Sub SingleValue(Extends s as DesktopSlider, Assigns value as Double)
