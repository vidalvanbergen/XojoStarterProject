#tag Module
Protected Module DesktopTextAreaExtension
	#tag Method, Flags = &h0
		Sub AlignJustified(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Function AutomaticDashSubstitutionEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub AutomaticDashSubstitutionEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function AutomaticDataDetectionEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub AutomaticDataDetectionEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function AutomaticLinkDetectionEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub AutomaticLinkDetectionEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function AutomaticQuoteSubstitutionEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub AutomaticQuoteSubstitutionEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function AutomaticSpellingCorrectionEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub AutomaticSpellingCorrectionEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function AutomaticTextReplacementEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub AutomaticTextReplacementEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function Bold(extends t as DesktopTextArea, offset as Integer, length as Integer) As Boolean
		  #if targetMacOS
	...
	#tag Method, Flags = &h0
		Sub Bold(extends t as DesktopTextArea, offset as Integer, length as Integer, assigns value as Boolean)
		  #if targetMacOS
		    declare function textStorage lib CocoaLib selector "textStorage" (obj_id as Ptr) as Ptr
		    declare function length_ lib CocoaLib selector "length" (obj_id as Ptr) as Integer
	...
	#tag Method, Flags = &h0
		Sub BreakUndoCoalescing(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub Complete(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Function ContinuousSpellCheckingEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub ContinuousSpellCheckingEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub CopyFont(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub CopyRuler(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Function DisplaysLinkToolTips(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub DisplaysLinkToolTips(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function DrawsBackground(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub DrawsBackground(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function Editable(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub Editable(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub FontBackgroundColor(Extends ta As DesktopTextArea, offset As Integer, length As Integer, Assigns value As Color)
		  #if TargetMacOS
	...
	#tag Method, Flags = &h0
		Function GrammarCheckingEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub GrammarCheckingEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function IncrementalSearchingEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub IncrementalSearchingEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub InsertText(extends t as DesktopTextArea, aText as String)
	...
	#tag Method, Flags = &h0
		Function IsCoalescingUndo(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Function Italic(extends t as DesktopTextArea, offset as Integer, length as Integer) As Boolean
		  #if targetMacOS
		    declare function textStorage lib CocoaLib selector "textStorage" (obj_id as Ptr) as Ptr
		    declare function length_ lib CocoaLib selector "length" (obj_id as Ptr) as Integer
	...
	#tag Method, Flags = &h0
		Sub Italic(extends t as DesktopTextArea, offset as Integer, length as Integer, assigns value as Boolean)
		  #if targetMacOS
		    declare function textStorage lib CocoaLib selector "textStorage" (obj_id as Ptr) as Ptr
		    declare function length_ lib CocoaLib selector "length" (obj_id as Ptr) as Integer
		    declare sub applyFontTraits lib "Cocoa.framework" selector "applyFontTraits:range:" (obj_id as Ptr, mask as int32, aRange as Cocoa.NSRange)
	...
	#tag Method, Flags = &h0
		Sub LoosenKerning(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub LowerBaseline(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub OrderFrontLinkPanel(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub OrderFrontListPanel(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub OrderFrontSpacingPanel(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub OrderFrontSubstitutionsPanel(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub OrderFrontTablePanel(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub PasteAsPlainText(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub PasteAsRichText(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub PasteFont(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub PasteRuler(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub RaiseBaseline(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Function ReadRTFDFromFile(extends t as DesktopTextArea, path as String) As Boolean
	...
	#tag Method, Flags = &h0
		Function RichText(extends t as DesktopTextArea) As Boolean
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Sub RichText(extends t as DesktopTextArea, assigns value as Boolean)
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Function RTFValue(extends t as DesktopTextArea) As String
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Sub RTFValue(extends t as DesktopTextArea, assigns value as String)
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Function RulerVisible(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub RulerVisible(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function Selectable(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub Selectable(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function ShowRuler(extends t as DesktopTextArea) As Boolean
		  #if targetCocoa
		    declare function isRulerVisible lib CocoaLib selector "isRulerVisible" (obj_id as Ptr) as Boolean
	...
	#tag Method, Flags = &h0
		Sub ShowRuler(extends t as DesktopTextArea, assigns value as Boolean)
		  #if targetCocoa
		    declare sub setRulerVisible lib CocoaLib selector "setRulerVisible:"  (obj_id as Ptr, value as Boolean)
	...
	#tag Method, Flags = &h0
		Function SmartInsertDeleteEnabled(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub SmartInsertDeleteEnabled(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub StartSpeaking(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub StopSpeaking(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h21
		Private Function TextViewRef(extends t as DesktopTextArea) As Ptr
		  #if targetCocoa
		    declare function documentView lib CocoaLib selector "documentView" (obj_id as Ptr) as Ptr
	...
	#tag Method, Flags = &h0
		Sub TightenKerning(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleAutomaticDashSubstitution(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleAutomaticDataDetection(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleAutomaticLinkDetection(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleAutomaticQuoteSubstitution(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleAutomaticSpellingCorrection(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleAutomaticTextReplacement(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleContinuousSpellChecking(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleGrammarChecking(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleRuler(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleSmartInsertDelete(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub ToggleTraditionalCharacterShape(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub TurnOffKerning(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub TurnOffLigatures(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub UseAllLigatures(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Function UseFindPanel(extends t as DesktopTextArea) As Boolean
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Sub UseFindPanel(extends t as DesktopTextArea, assigns value as Boolean)
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Function UseFontPanel(extends t as DesktopTextArea) As Boolean
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Sub UseFontPanel(extends t as DesktopTextArea, assigns value as Boolean)
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Function UseRuler(extends t as DesktopTextArea) As Boolean
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Sub UseRuler(extends t as DesktopTextArea, assigns value as Boolean)
		  #if targetCocoa
	...
	#tag Method, Flags = &h0
		Function UsesFindBar(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub UsesFindBar(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function UsesFindPanel(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub UsesFindPanel(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function UsesFontPanel(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub UsesFontPanel(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function UsesInspectorBar(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub UsesInspectorBar(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function UsesRuler(extends t as DesktopTextArea) As Boolean
	...
	#tag Method, Flags = &h0
		Sub UsesRuler(extends t as DesktopTextArea, assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub UseStandardKerning(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Sub UseStandardLigatures(extends t as DesktopTextArea)
	...
	#tag Method, Flags = &h0
		Function WriteRTFDToFile(extends t as DesktopTextArea, path as String, atomically as Boolean) As Boolean
