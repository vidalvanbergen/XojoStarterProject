#tag Module
Protected Module DesktopTextFieldExtension
	#tag Method, Flags = &h0
		Function AttributedStringValue(extends TF as DesktopTextField) As AttributedString
		  //# Returns the value of the text field’s cell as an attributed string.
		    ...
		    dim ctrl as Ptr = TF.Handle //TF.TextViewRef //Ptr( TF.Handle )
		    dim p as Ptr
	...
	#tag Method, Flags = &h0
		Function Bezeled(Extends t as DesktopTextField) As Boolean
	...
	#tag Method, Flags = &h0
		Sub Bezeled(Extends t as DesktopTextField, Assigns value as Boolean)
		  //# Specifies whether the text field draws a bezeled border.
		  
		  #if TargetCocoa then
		    declare sub setBezeled lib CocoaLib selector "setBezeled:" (obj_id as Ptr, flag as Boolean)
	...
	#tag Method, Flags = &h0
		Function BezelStyle(Extends t as DesktopTextField) As NSTextFieldBezelStyle
		  //# Returns the text field’s bezel style.
		  
		  #if TargetCocoa then
		    declare function bezelStyle lib CocoaLib selector "bezelStyle" (obj_id as Ptr) as NSTextFieldBezelStyle
	...
	#tag Method, Flags = &h0
		Sub BezelStyle(Extends t as DesktopTextField, Assigns style as NSTextFieldBezelStyle)
		  //# Sets the text field’s bezel style.
		  
		  #if TargetCocoa then
		    declare sub setBezelStyle lib CocoaLib selector "setBezelStyle:" (obj_id as Ptr, style as NSTextFieldBezelStyle)
	...
	#tag Method, Flags = &h0
		Function Bordered(Extends t as DesktopTextField) As Boolean
	...
	#tag Method, Flags = &h0
		Sub Bordered(Extends t as DesktopTextField, Assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function DoubleValue(Extends t as DesktopTextField) As Double
	...
	#tag Method, Flags = &h0
		Sub DoubleValue(Extends t as DesktopTextField, Assigns value as Double)
	...
	#tag Method, Flags = &h0
		Function Editable(Extends t as DesktopTextField) As Boolean
	...
	#tag Method, Flags = &h0
		Sub Editable(Extends t as DesktopTextField, Assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Function IntegerValue(Extends t as DesktopTextField) As Integer
	...
	#tag Method, Flags = &h0
		Sub IntegerValue(Extends t as DesktopTextField, Assigns value as Integer)
	...
	#tag Method, Flags = &h0
		Function PlaceholderString(extends t as DesktopTextField) As String
	...
	#tag Method, Flags = &h0
		Sub PlaceholderString(extends t as DesktopTextField, assigns value as String)
	...
	#tag Method, Flags = &h0
		Function Selectable(Extends t as DesktopTextField) As Boolean
	...
	#tag Method, Flags = &h0
		Sub Selectable(Extends t as DesktopTextField, Assigns value as Boolean)
	...
	#tag Method, Flags = &h0
		Sub SetLineBreak(extends TF as DesktopTextField, assigns mode as integer)
	...
	#tag Method, Flags = &h0
		Function SingleValue(Extends t as DesktopTextField) As Double
	...
	#tag Method, Flags = &h0
		Sub SingleValue(Extends t as DesktopTextField, Assigns value as Double)
	...
	#tag Method, Flags = &h21
		Private Function TextViewRef(extends t as DesktopTextField) As Ptr
		  #if TargetCocoa then
