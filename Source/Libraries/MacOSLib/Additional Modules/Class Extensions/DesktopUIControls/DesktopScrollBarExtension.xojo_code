#tag Module
Protected Module DesktopScrollBarExtension
	#tag Method, Flags = &h0
		Function ControlSize(Extends s as DesktopScrollBar) As NSControlSize
	...
	#tag Method, Flags = &h0
		Sub ControlSize(Extends s as DesktopScrollBar, Assigns value as NSControlSize)
