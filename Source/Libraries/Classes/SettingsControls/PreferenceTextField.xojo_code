#tag Class
Protected Class PreferenceTextField
Inherits DesktopTextField
	#tag Event
		Sub Opening()
		  ...
		  if DefaultsName <> "" and AppSettings.Prefs.Value( DefaultsName, "" ) <> "" then
		    Text = AppSettings.Prefs.Value( DefaultsName, "" )
		  end if
		...
		Sub TextChanged()
		  ...
		  if SettingDefaultValue then
		    ...
		    if DefaultsName <> "" then
		      AppSettings.Prefs.Value( DefaultsName ) = me.Text
		    end if
