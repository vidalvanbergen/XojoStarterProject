...
Protected Module ToolbarExtensions
	...
	#tag Method, Flags = &h0
		Sub AddControl(Extends pToolbar as NSToolbar, pControl as DesktopUIControl, Name as String, PaletteName as String = "", ItemToolTip as String = "")
		  if PaletteName = "" then
		  ...
		  if pControl IsA DesktopUIControl then
		    dim rControl as DesktopUIControl = DesktopUIControl( pControl )
		    ControlWidth = rControl.Width
		    ControlHeight = rControl.Height+8
		  else
		  ...
		  customToolItem.MinSize = Cocoa.NSMakeSize( ControlWidth, ControlHeight )
	...
	#tag Method, Flags = &h0
		Sub AddDropItem(Extends pToolbar as NSToolbar, Identifier as string, TheImage as NSImage, Name as String, TheMenu as NSMenu, PalleteName as String = "", ItemToolTip as String = "", ImageIsTemplate as Boolean = False)
		  ...
		  toolbarItem.Image.Template = ImageIsTemplate
